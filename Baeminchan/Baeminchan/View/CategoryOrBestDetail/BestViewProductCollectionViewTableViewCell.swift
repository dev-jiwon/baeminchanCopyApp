//
//  BestViewProductCollectionViewTableViewCell.swift
//  Baeminchan
//
...
class BestViewProductCollectionViewTableViewCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        super.awakeFromNib()
        // Initialization code
        NotificationCenter.default.addObserver(self, selector: #selector(notificationReceived(notification:)), name: Notification.Name("categoryNotification"), object: nil)
...
extension BestViewProductCollectionViewTableViewCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
//text 커스터마이징
extension BestViewProductCollectionViewTableViewCell {
    //원래 판매 가격에 취소선을 긋는다
